...
class Favori extends React.Component {
  ...
  state = { title: "Favori", favori: this.props.match.params.id, personnages: [], planets: [], starships: [], currentType: null };
        ...
        <h1 className="category-title">Details du favori</h1>
            <div className="card">
              <ul className="list-group list-group-flush">
                ...
                <button className="btn btn-secondary" onClick={() => this.handleUpdate(this.state.favori)}>Modifier</button>
              </ul>
            </div>
      </div>
    );
